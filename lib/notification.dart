...
class NotificationSetUp {
  ...
  Future<void> initializeNotification() async {
    AwesomeNotifications().initialize('resource://drawable/res_launcher_icon', [
      NotificationChannel(
          ...
          channelName: 'Aleart Notification',
          importance: NotificationImportance.Max,
          vibrationPattern: highVibrationPattern,
          channelShowBadge: true,
          channelDescription: 'Aleart Notification disc'),
    ]);
  ...
  void configurePushNotification(BuildContext context) async {
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      print("++++++++++++++++++++====");
      print("__________${message.notification!.body}____");
      print("____________");
  ...
  void eventListenerCallback(BuildContext context){
    AwesomeNotifications().setListeners(onActionReceivedMethod: NotificationContoller.onActionReceivedMethod);
  }
...
class NotificationContoller{
  ///Use this method to detect when a new notification or a schedule or a schedule is created
  @pragma("vm:entry-point")
  static Future<void> onActionReceivedMethod(ReceivedNotification receivedNotification) async{
    // Your code goes here
    // when a notificaton is clicked the code is here
